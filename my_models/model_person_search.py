...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.text_encoder = BertForMaskedLM.from_pretrained("/dssg/work3/xlyang/xlyang/wcj/cxd/.cache/text_enconder", config=bert_config)
        ...
        self.text_encoder_m = BertForMaskedLM.from_pretrained("/dssg/work3/xlyang/xlyang/wcj/cxd/.cache/text_enconder", config=bert_config)
